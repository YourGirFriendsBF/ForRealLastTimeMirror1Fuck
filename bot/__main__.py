...
from bot import bot, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, LOGGER, Interval, INCOMPLETE_TASK_NOTIFIER, AUTHORIZED_CHATS, DB_URI, alive, app, main_loop, rss_session, USER_SESSION_STRING
...
def stats(update, context):
    ...
    stats = f'<b><i><u>Dhruv Mirror Bot Statistics</u></i></b>\n\n'\
